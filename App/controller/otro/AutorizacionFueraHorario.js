Ext.define('proyecto.controller.AutorizacionFueraHorario', {
    extend: 'Ext.app.Controller',
    stores: ['AutorizacionFueraHorarioStore'],
    models: ['AutorizacionFueraHorarioModel'],
    views: ['autorizacion.gridAutorizacionHorario', 'Formulario', 'Window'],
    refs: [
        {
            ref: 'list',
