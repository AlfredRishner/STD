Ext.define('proyecto.view.tipo.gridTipo_Documento', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.gridTipo_Documento',
       requires: [
   ...
   /* viewConfig: {
    ...
    //Textos completos 	id 	idUsuario 	asunto 	consulta 	captura 	prioridad 
        ...
        {header: 'idtipo', sortable: true, hidden: true, dataIndex: 'idtipo'},
