...
/*
				$pdf->Image('logo2.jpg',20,20,80);
				$pdf->Image('fotos/0001.JPG',23,35,20);
				//carne 01 
				$pdf->Rect(20,20,80,50,'D');//cuadrado de impresion
				...
				//$pdf->Text(54,36,'Carn� de Estudiante');
				$pdf->Text(54,40,'C�digo:');
				$pdf->Text(54,44,'Apellidos:');
				$pdf->Text(54,56,'Nombres:');
				$pdf->SetFont('Times','',11);
				$pdf->Text(70,40,'051208');
				$pdf->Text(54,48,'LOZA:');
				$pdf->Text(54,52,'TORRES');
				$pdf->Text(54,60,'ALFRED RISHNER');
				$pdf->SetFont('Times','',5);
				$pdf->Text(50,69,'');
				$pdf->Code39(50,61,'051208',1,6);
				//fin de  carne 01 
				
				$pdf->Image('logo2.jpg',20+97,20,80);
				$pdf->Image('fotos/0001.JPG',120,35,20);
				//carne 02 
				$pdf->Rect(20+97,20,80,50,'D');//cuadrado de impresion
				//$pdf->Rect(21,36,32,24,'D');//cuadrado de impresion
				$pdf->SetFont('Times','',12);
				//$pdf->Text(35,25,'.:Academia PreUniversitaria:.');
				//$pdf->SetFont('Times','',14);
				...
				$pdf->SetFont('Times','',10);
				//$pdf->Text(54,36,'Carn� de Estudiante');
				$pdf->Text(54+97,40,'C�digo:');
				$pdf->Text(54+97,44,'Apellidos:');
				$pdf->Text(54+97,56,'Nombres:');
				$pdf->SetFont('Times','',11);
				$pdf->Text(70+97,40,'051208');
				$pdf->Text(54+97,48,'LOZA:');
				$pdf->Text(54+97,52,'TORRES');
				$pdf->Text(54+97,60,'ALFRED RISHNER');
				$pdf->SetFont('Times','',5);
				$pdf->Text(50+97,69,'');
				$pdf->Code39(50+97,61,'051208',1,6);
				//fin de  carne 02 
				*/
...
{	    $espacio=0;
		for($cont=0;$cont<5;$cont++)
		{
				...
				{				
				$pdf->Image('REVERSO.jpg',13,20+$espacio,80);
				...
				*/
				...
				$sql2="select * from personal WHERE `id` ='$numero'+1";
				$rs2=mysql_query($sql2);
				while($campo2=mysql_fetch_array($rs2))
				{	
				$pdf->Image('REVERSO.jpg',13+97,20+$espacio,80);
				...
				$pdf->SetFont('Times','',10);
				//$pdf->Text(54,36,'Carn� de Estudiante');
				$pdf->Text(54+97,40+$espacio,'C�digo:');
...
while($campo=mysql_fetch_array($rs))
{
								...
								//desde aqui vemos los mese del a�o
											if($campo[cc]=='1')
												$meses='Enero';
											if($campo[cc]=='2')
												$meses='Febrero';
...
//desde aqiu para alla
    ...
    $pdf->SetFont('Arial','B',15);
    //T�tulo2
    $pdf->Cell(0,0,'Vicerrectorado Acad�mico',0,0,'C');
    $pdf->Ln(7);
    //Arial bold 10
    $pdf->SetFont('Arial','B',11);
    //T�tulo3
    $pdf->Cell(0,0,'Oficina de Tecnologia Inform�tica',0,0,'C');
    //Salto de l�nea
    $pdf->Ln(3);
	//ponemos grososr de la linea jejej
